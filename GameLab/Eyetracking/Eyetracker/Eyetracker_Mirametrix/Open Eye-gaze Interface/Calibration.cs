...
namespace GameLab.Eyetracking.OpenEyeGazeInterface
{
    ...
    public class Calibration
    {
        ...
        public bool CALIBRATE_START(bool start)
        {
            ...
            // ACK
            var answer = Connection.ReceiveAnswer(id);
            ...
            if (answerParam.ElementAt(0).Value != (start == true ? "0" : "1"))
            {
                if (answerParam.ElementAt(0).Value == (start == true ? "1" : "0"))
                    return true;
                else
                    return false;
            }
            ...
            sendParam.Add(answerParam.ElementAt(0).Key, (start == true ? "1" : "0"));
            var secondCommand = Command.Create("SET", id, sendParam);
            if (!Connection.Send(secondCommand))
                return false;

            //  ACK
            answer = Connection.ReceiveAnswer(id);
        ...
        /// </summary>
        /// <returns>True if success</returns>
        public bool CALIBRATE_SHOW(bool start)
        {
            ...
            // ACK
            var answer = Connection.ReceiveAnswer("CALIBRATE_SHOW");
            ...
            // ACK
            answer = Connection.ReceiveAnswer("CALIBRATE_SHOW");
        ...
        public bool CALIBRATE_DELAY(float value)
        {
            ...
            // ACK
            var answer = Connection.ReceiveAnswer("CALIBRATE_DELAY");
            ...
            // ACK
            answer = Connection.ReceiveAnswer("CALIBRATE_DELAY");
        ...
        public bool CALIBRATE_TIMEOUT(float value)
        {
            ...
            // ACK
            var answer = Connection.ReceiveAnswer("CALIBRATE_TIMEOUT");
            ...
            // ACK
            answer = Connection.ReceiveAnswer("CALIBRATE_TIMEOUT");
        ...
        public bool CALIBRATE_FAST(bool state)
        {
            ...
            // ACK
            var answer = Connection.ReceiveAnswer("CALIBRATE_FAST");
            ...
            // ACK
            answer = Connection.ReceiveAnswer("CALIBRATE_FAST");
        ...
        {
            var answer = Connection.ReceiveAnswer("CALIB_START_PT");
        ...
        {
            var answer = Connection.ReceiveAnswer("CALIB_RESULT_PT");
            calibPtStruct = new CALIB_PT_STRUCT();
        ...
        {
            var answer = Connection.ReceiveAnswer("CALIB_RESULT");
        ...
        public bool CALIB_RESULT_SUMMARY(out CALIB_RESULT_SUMMARY_STRUCT calibResultSummaryStruct)
        {
            ...
            var id = "CALIBRATE_RESULT_SUMMARY";
            ...
            // ACK
            var answer = Connection.ReceiveAnswer("CALIBRATE_RESULT_SUMMARY");
