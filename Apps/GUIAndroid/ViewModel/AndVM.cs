...
namespace GuiAndroid.ViewModel
{
    public class AndVM : MVVMKit.ViewModel
    {
        ...
        private void Connection_StringReceived(object sender, string e)
        {
            switch (e[0])
            {
                ...
                case 'H':
                    ...
                    break;
                case 'A':
                    App.AlertServices.AlertVibrateAsync("Alarm", "Pacjent potrzebuje pomocy", "ok", 10000);
                    break;
            }
        }
        ...
        private ICommand connectbtn;

        public ICommand ConnectBtnClicked
        {
            get
            {
                if (connectbtn == null)
                    connectbtn = new RelayCommand(o =>
                    {
                        ConnectPlease();
                    });
                return connectbtn;
